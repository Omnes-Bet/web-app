        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography>
              ...
              <Typography variant="body1" className={classes.description}>
                Cada usuário só pode criar uma conta. A criação de várias contas
                é estritamente proibida e pode resultar na suspensão ou
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography>
              ...
              <Typography variant="body1" className={classes.description}>
                Aceitamos cartões de crédito. Consulte nossa página de pagamento
            ...
            <Typography>
              ...
              <Typography variant="body1" className={classes.description}>
                ...
                <ul className={classes.description}>
                  ...
                  <li>
                    Usando nossa plataforma para qualquer atividade ilegal
                  </li>
                  <li>Assediar ou intimidar outros usuários</li>
                  <li>Criando várias contas</li>
                  <li>
                    Envolver-se em qualquer atividade que viole nossos termos de
                    serviço
                  </li>
                </ul>
              </Typography>
