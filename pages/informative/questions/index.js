...
function FAQ() {
  ...
  const pageSeoProps = {
    title: "Omnesbet | Perguntas Frequentes",
    description: "Tire suas dúvidas com a OmnesBet",
    pageUrl: pageUrl,
  };
            ...
            <AccordionDetails>
              <Typography>
                ...
                <Typography variant="body1" className={classes.answer}>
                  ...
                  esportivos e identifica oportunidades de surebet em tempo
                  real. Você pode usar nossa plataforma para procurar surebets
                  em esportes, ligas ou eventos específicos e filtrar os
                  resultados com base em diferentes critérios, como margem de
                  lucro, odds mínimas e máximas e preferências de casa de
                  apostas. Depois de identificar uma surebet, nosso software
                  calcula as quantias para apostar em cada resultado, levando em
                  consideração as probabilidades e a comissão cobrada pelas
                  casas de apostas.
                </Typography>
            ...
            <AccordionDetails>
              <Typography>
                ...
                <Typography variant="body1" className={classes.answer}>
                  ...
                  consentimento. Também cumprimos todas as leis e regulamentos
                  de proteção de dados aplicáveis ​​para garantir que seus
                  direitos de privacidade sejam totalmente respeitados.
                </Typography>
                ...
                <Typography variant="body1" className={classes.answer}>
                  ...
                  incluindo verificações de credenciais, rastreamento de IP e
                  monitoramento de transações. Também trabalhamos em estreita
                  colaboração com nossos parceiros de pagamento e casas de
                  apostas para garantir que todas as transações sejam legítimas
                  e transparentes.
                </Typography>
              </Typography>
            </AccordionDetails>
            ...
            <AccordionDetails>
              <Typography>
                ...
                <Typography variant="body1" className={classes.answer}>
                  ...
                  problema que você possa ter. Você pode entrar em contato
                  conosco por e-mail e faremos o possível para responder o mais
                  rápido possível.
                </Typography>
              </Typography>
            </AccordionDetails>
