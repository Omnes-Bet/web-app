...
function PrivacyPolicy() {
  ...
  const pageSeoProps = {
    title: "Omnesbet | Política de Privacidade",
    description: "Conheça um pouco mais nossas Políticas de Privacidade",
    pageUrl: pageUrl,
  };
      ...
      <div className={classes.container}>
        <div className={classes.wrapper}>
          ...
          <p className={classes.text}>
            ...
            nos comprometemos a proteger suas informações pessoais. Esta
            política de privacidade descreve nossas práticas para coleta, uso e
          ...
          <p className={classes.text}>
            ...
            serviços, incluindo seu endereço de IP, tipo de navegador e
            informações do dispositivo. Essas informações podem ser coletadas
            por meio do uso de cookies, web beacons e outras tecnologias de
            rastreamento.
          </p>
          ...
          <p className={classes.text}>
            ...
            produtos, mas não vendemos nem alugamos suas informações pessoais
            para terceiros.
          </p>
          ...
          <p className={classes.text}>
            ...
            padrões do setor para protegê-las contra acesso, divulgação e
          ...
          <p className={classes.text}>
            Poderemos atualizar esta política de privacidade de tempos em tempos
            e notificaremos você sobre quaisquer alterações, publicando a nova
