          ...
          <Grid item xs={6} lg={2}>
            <FooterList
              ...
              options={[
                ...
                { title: 'Accounts & Payouts', route: '/accounts-payouts-and-bonuses' }
              ]}
            />
          </Grid>
          <Grid item xs={6} lg={2}>
            <FooterList
              title='About'
              options={[{ title: 'Who we are', route: '/quem-somos' }, { title: 'Privacy Policy' }]}
            />
          </Grid>
        </Grid>
...
const FooterList = ({ title, options = [] }) => {
  return (
    <List>
      <ListItem>
        <Box fontWeight='box.fontWeight' fontSize='box.fontSize' color='grey.400'>
